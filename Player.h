...
private:
    int m_playerId;
    std::shared_ptr<Team> m_originalTeam;
    int m_spot;
...
bool compareIdPlayers(const Player& p1, const Player& p2); ///check if p1 id is greater than p2
int compareGoals(const Player& p1, const Player& p2); ///check if p1 goals is greater than p2
